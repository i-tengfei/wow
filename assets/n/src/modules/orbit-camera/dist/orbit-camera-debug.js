define("ndi/orbit-camera/0.1.0/orbit-camera-debug", [ "ndi/render/0.58.0/render-debug", "ndi/math/0.1.0/math-debug" ], function(require, exports, module) {
    var RENDER = require("ndi/render/0.58.0/render-debug");
    var math = require("ndi/math/0.1.0/math-debug");
    var PIXELS_PER_ROUND = 1800;
    function OrbitCamera(options, app) {
        RENDER.Camera.call(this);
        this.container = new RENDER.Object3D();
        this.container.add(this);
        var mouseManager = app.enableMouse().mouseManager;
        delete options.element;
        this.attributes = {};
        this.positionWorld = new RENDER.Vector3();
        this.rotationWorld = new RENDER.Vector3();
        this.val(options);
    ...
    OrbitCamera.prototype.val = function(options) {
        ...
        if (options !== undefined) {
            ...
            attrs.phi = math.check(options.phi, Math.PI * .5);
    ...
    OrbitCamera.prototype.run = function(camera) {
        ...
        this.rotationWorld.setEulerFromRotationMatrix(this.matrixWorld);
    };
