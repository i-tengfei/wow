define( function( require, exports, module ) {
	...
	Model.prototype.createOwnMesh = function( callback ){
		...
		geometry = new Geo(
			geoAttrs[ 0 ], geoAttrs[ 1 ], geoAttrs[ 2 ],
			geoAttrs[ 3 ], geoAttrs[ 4 ], geoAttrs[ 5 ],
			geoAttrs[ 6 ], geoAttrs[ 7 ], geoAttrs[ 8 ]
		);
	...
	Model.prototype.getMaterials = function( materials, callback ){
		...
		var __this__ = this;
		materials = materials || [ { color:0x9C9C9C } ]
	...
	Model.prototype.updateMap = function( ){
		...
		var geometry = this.render.geometry,
			material = this.render.material;
