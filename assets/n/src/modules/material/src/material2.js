define( function( require, exports, module ) {
	...
	Material.config = [
		{
			...
			name: 'overdraw',
			cname: '透支',
			type: 'number',// for CanvasRenderer
			default: 0,
			setType: 'value'
		}*/,{
			name: 'visible',
	...
	matAttrs.basic = [
		'color', 
		'map', 'lightMap', 'specularMap', 'envMap', 
		'combine',
	...
	matAttrs.lambert = [
		'ambient', 'emissive', 'wrapAround', 'wrapRGB', 'morphNormals'
	].concat( matAttrs.basic );
