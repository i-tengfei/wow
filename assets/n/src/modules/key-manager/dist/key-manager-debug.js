define("ndi/key-manager/0.1.0/key-manager-debug", [ "ndi/event-listener/0.1.0/event-listener-debug", "ndi/events/0.1.0/events-debug" ], function(require, exports, module) {
    ...
    KeyManager.prototype.KEY_DOWN = "keyDown";
    KeyManager.prototype.KEY_UP = "keyUp";
    KeyManager.prototype.LEFT = "mouseLeft";
    KeyManager.prototype.MIDDLE = "mouseMiddle";
    KeyManager.prototype.RIGHT = "mouseRight";
    ...
    KeyManager.prototype.down = function(kCode) {
        ...
        if (key) {
            ...
            this.trigger(this.KEY_DOWN, key.keyName, this.domEvents.getEvent());
        }
    };
    KeyManager.prototype.up = function(kCode) {
        ...
        if (key) {
            ...
            this.trigger(this.KEY_UP, key.keyName, this.domEvents.getEvent());
        }
    };
