define("ndi/event-listener/0.1.0/event-listener-debug", [ "ndi/events/0.1.0/events-debug" ], function(require, exports, module) {
    ...
    function DomEvents(element) {
        ...
        element.addEventListener("mousemove", function(event) {
            ...
            e.offsetX = event.offsetX;
            e.offsetY = event.offsetY;
            e.dx = nx - e.ox;
            e.dy = ny - e.oy;
        ...
        element.addEventListener("mousewheel", function(event) {
            __this__.trigger(EventListener.MOUSE_WHEEL, event.wheelDelta > 0 ? 1 : -1);
        });
        // FF
        element.addEventListener("DOMMouseScroll", function(event) {
            __this__.trigger(EventListener.MOUSE_WHEEL, -event.detail > 0 ? 1 : -1);
        });
        // --------------- Mouse Out --------------- //
    ...
    DomEvents.prototype.checkFather = function(e) {
        var parent = e.relatedTarget, element = this.element;
        try {
